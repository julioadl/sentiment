#!/bin/sh
python3.6 run_experiment.py --gpu=-1 '{"dataset": "Sentiment140CharacterLevelSmall", "model": "Sentiment140Model", "algorithm": "lstm_chars", "algorithm_args": {"dropout": 0}, "train_args": {"epochs": 10, "lr": 0.001, "beta_1": 0.999}}'
